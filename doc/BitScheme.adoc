...
; .Immediate <[.imm11-0 <12 Bit>, RS1, FUNCT3, RD, OP.Immediate]>;
; .UpperImmediate <[.imm31-12 <20 Bit>, RD, OP.Upper]>;
; .Store <[.imm11-5 <7 Bit>, SOURCE, .imm4-0 <5 Bit>, OP.Store]>;
; .Branch <[.b12 <Bit>,.imm10-5 <6 Bit>, SOURCE, .imm4-1 <4 Bit>,.b11 <Bit>, OP.Branch]>;
; .Jump <[.b20 <Bit>,.imm10-1 <10 Bit>, .b11 <Bit>, .imm19-12 <8 Bit>, RD, OP.Jump]>;
; .RiscV <Register, Immediate, UpperImmediate, Store, Branch, Jump>;
